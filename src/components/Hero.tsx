...
export default function Hero() {
  return (
    <section className="relative h-screen flex flex-col justify-center items-center text-center overflow-hidden bg-[var(--vm-green-950)]">
      
      {/* 1. BACKGROUND IMAGE (Full Cover like reference) */}
