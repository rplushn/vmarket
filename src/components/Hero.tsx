...
export default function Hero() {
  return (
    <section className="relative h-screen min-h-[100dvh] flex flex-col items-center text-center overflow-hidden bg-[var(--vm-green-950)] isolation-auto pt-40 md:justify-center md:pt-0">
      ...
      <div className="vm-container relative z-20 px-4 flex-1 flex flex-col justify-between md:flex-none md:justify-center md:mt-[300px] w-full max-w-5xl">
        ...
        <div className="relative flex flex-col gap-4 justify-center items-center animate-fade-in-up-delay-2 mt-auto pt-4 mb-24 pb-8 md:mt-0 md:pt-0 md:mb-5 md:pb-0 md:flex-row md:gap-6">
          <button
            type="button"
          ...
          <button className="group flex items-center justify-center gap-2 text-white px-8 py-4 rounded-full font-light text-lg hover:text-[var(--vm-accent-lime)] transition-all duration-300 w-full sm:w-auto md:w-auto md:min-w-0">
